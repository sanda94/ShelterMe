...
const AnimalFoundForm = ({ setShowModal, getAnimal, editData = "" }) => {
  ...
  useEffect(() => {
    const getAnimal = async () => {
      try {
        if (editData === "") return;
        const res = await axios.get(`/animalFound/` + editData, {
          headers: {
          ...
          <div className="border-b border-stroke py-4 px-6.5 dark:border-strokedark">
            <div className="flex w-full	justify-between">
              <h3 className="font-medium text-black dark:text-white">
                {editData ? " Update Found Animal" : "Add New Found Animal"}
              </h3>
          ...
          <form action="#">
            <div className="p-6.5">
              ...
              <div className="mb-4.5">
                ...
                />
                {err?.phoneNumber ? (
                  <p className="text-[#FF0000]">{err.phoneNumber}</p>
                ) : (
                  <p>
                    <br />
                  </p>
              ...
              <div className="mb-4.5">
                ...
                />
                {err?.longitude ? (
                  <p className="text-[#FF0000]">{err.longitude}</p>
                ) : (
                  <p>
                    <br />
                  </p>
              ...
              <div className="mb-4.5">
                ...
                />
                {err?.latitude ? (
                  <p className="text-[#FF0000]">{err.latitude}</p>
                ) : (
                  <p>
                    <br />
                  </p>
